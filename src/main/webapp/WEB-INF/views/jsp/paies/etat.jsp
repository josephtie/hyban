                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <%--<li role="presentation" class="dropdown-header">Dropdown header</li>--%>
                                            <li><a href="#" data-toggle="modal" data-target="#rhpModal">Cotisation mensuelle</a></li>
                                        <!--      <li><a href="#" data-toggle="modal" data-target="#rhpModal1">Cotisation Trimestrielle</a></li> -->
                                             <li><a href="#" data-toggle="modal" data-target="#rhpModal2">Cotisation annuelle(Disa)</a></li>
                                    </ul>
                                </div>
...
<%--<div class="widget">--%>
	<%--<div class="widgetbox">                        --%>
	   ...
	   <%----%>
	            ...
	            <%--</ul>--%>
	        <%--</div>--%>
	        <%--<h4 id="widgetTitle" class="widgettitle">Cotisations</h4>--%>
	    <%--</div>--%>
...
<!--                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
                ...
                <div class="modal-body">
                	...
                	<div class="form-group">
                        <label for="mois" class="col-md-4 control-label">Annn�e </label>
                        <div class="col-md-8">
...
app.controller('formAjoutCtrl', function ($scope) {
	...
	jQuery(document).ready(function($){
		...
		$("#formAjout").submit(function(e){
			...
			window.open(baseUrl  + "/paie/JRCotisationMensuelEmployeur?periode="+jQuery('#periode').val()+"&tPf="+ 0 +"&tAt="+ 0 +"&tCnps="+ 0 +"&print="+ jQuery('#print').val());
		...
		$("#formAjout1").submit(function(e){
			...
			window.open(baseUrl  + "/paie/jrDisaTrimestriel?periode1="+jQuery('#periode1').val()+"&tPf1="+ 0+"&tAt1="+ 0+"&tCnps1="+ 0+"&print1="+ jQuery('#print1').val());
		...
		$("#formAjout5").submit(function(e){
			...
			window.open(baseUrl  + "/paie/JrEtat?annee="+jQuery('#annee1').val());
