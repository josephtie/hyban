		...
		<div id="tableWidget" class="widgetcontent">
			<div id="toolbar1">
			    <div class="form-inline">
			     <button id="btnGenerer" type="submit" data-toggle="modal" data-target="#rhpModal" title="Cocher les employés mis en sommeil" class="btn btn-success btn-xs"><i class="fa fa-plus"></i>Générer livre de paie</button>
				...
				<table id="tableBull" class="table table-info table-striped"
					...
					<thead>
						<tr>
							...
							<th data-field="anciennete"  data-align="center">Ancienneté</th>
							...
							<th data-field=montantPrimeanciennete  data-align="center">Prime. Ancienneté</th>
							...
							<th data-field="montantpretaloes"  data-align="center">Prêt</th>
							...
							<th data-field="montantNetapayer"  data-align="center">Net à payer</th>
...
<!--                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
                ...
                <div class="modal-body">
                	<h3>Vous êtes sur le point de g&eacute;n&eacute;rer le bulletin de paie de la p&eacute;riode de <span id="periodePaie" class="danger">Mars 2016</span> du personnel.</h3>
                	<br/>
...
<!--                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
                ...
                <!-- <div id="toolbar">
			    <div class="form-inline">
			        <button id="btnGenerer5" type="submit" data-toggle="modal" data-target="#rhpModal5 " title="Cocher les employés mis en sommeil" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>Générer tous les bulletins</button>
			    </div>
			   </div> -->
				...
				<table id="tableliv" class="table table-info table-striped"
					...
					<thead>
						<tr>
							...
							<th data-field="mtprimeAnciennete"  data-align="center">Prime. Ancienneté</th>
							...
							<th data-field="mtpretAlios"  data-align="center">Prêt</th>
							...
							<th data-field="mtnetPayer"  data-align="center">Net à payer</th>
	...
	jQuery("#formModificationBulletin").submit(function(e){
        ...
        jQuery.ajax({
            ...
            error: function () {
            	...
            	jQuery("#rhpModalModif .modal-body .alert p").html("Verifier que vous êtes connectés au serveur.");
    ...
    jQuery.ajax({
        ...
        success: function (reponse) {
            if (reponse.result == "success") {
        		...
        		alert('Operation effexctuée avec succes');
            }
            else if(reponse.result == "erreur_champ_obligatoire"){
            	alert("Saisie invalide");
            }
        ...
        error: function () {
        	...
        	jQuery("#rhpModalPret .alert p").html("Verifier que vous êtes connectés au serveur."); */
