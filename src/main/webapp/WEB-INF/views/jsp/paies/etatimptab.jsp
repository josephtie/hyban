                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <%--<li role="presentation" class="dropdown-header">Dropdown header</li>--%>
                                            <li><a href="#" data-toggle="modal" data-target="#rhpModal2">Etat salaires</a></li>

                                            <li><a href="#" data-toggle="modal" data-target="#rhpModal3">Recap salaires</a></li>

                                           <li><a href="#" data-toggle="modal" data-target="#rhpModal4">Verif vers.</a></li>

                                           <li><a href="#" data-toggle="modal" data-target="#rhpModal5">Regul. Etat 301</a></li>
                                    </ul>
                                </div>
...
<!--                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
                ...
                <div class="form-group">
                        <label for="mois" class="col-md-4 control-label">Annee </label>
                        <div class="col-md-8">
                           <select id="annee2" name="annee2" class="form-control select2" required="required">
                           </select>
                        </div>
                    </div>
             <!--        <div class="form-group">
...
<!--                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
                ...
                <div class="modal-body">
                	...
                	<div class="form-group">
                        <label for="mois" class="col-md-4 control-label">Mois </label>
                        <div class="col-md-8">
                           <select id="annee5" name="annee5" class="form-control select2" required="required">
                           </select>
                        </div>
                    </div>
                    <div class="form-group">
...
app.controller('formAjoutCtrl', function ($scope) {
	...
	/* 	$("#formAjout").submit(function(e){
			e.preventDefault();
			 ...
			 location.href = baseUrl + "/paie/JRCotisationMensuelEmployeur?periode="+jQuery('#periode').val()+"&tPf="+ jQuery('#tPf').val()+"&tAt="+ jQuery('#tAt').val()+"&tCnps="+ jQuery('#tCnps').val()+"&print="+ jQuery('#print').val();
		...
		$("#formAjout1").submit(function(e){
			e.preventDefault();
				 ...
				 location.href = baseUrl + "/paie/jrDisaTrimestriel?periode1="+jQuery('#periode1').val()+"&tPf1="+ jQuery('#tPf1').val()+"&tAt1="+ jQuery('#tAt1').val()+"&tCnps1="+ jQuery('#tCnps1').val()+"&print1="+ jQuery('#print1').val();
		...
		$("#formAjout2").submit(function(e){
				...
				window.open(baseUrl + "/paie/JrEtat?annee="+jQuery('#annee').val());
		...
		$("#formAjout3").submit(function(e){
			...
			window.open(baseUrl +  "/paie/Jrtab2?annee="+jQuery('#annee2').val()+"&print="+ jQuery('#print2').val());
	      
			});
	 	$("#formAjout4").submit(function(e){
			e.preventDefault();
				
			window.open(baseUrl +  "/paie/Jrtab33?annee="+jQuery('#annee5').val()+"&print="+ jQuery('#print4').val());
		...
		$("#formAjout5").submit(function(e){
			e.preventDefault();
			 ...
			 window.open(baseUrl + "/paie/jrItsann?periode="+jQuery('#annee1').val());
		...
		jQuery.ajax({
	        ...
	        success: function (response) {
	        	if (response != null) {
					...
					jQuery('#annee2').html(tabledata);
					jQuery('#annee2').select2('val', 0);
					jQuery('#annee5').html(tabledata);
					jQuery('#annee5').select2('val', 0);
					//jQuery('#branch').select2('val', index);
				} else {
					alert('Failure! An error has occurred!');
				}
