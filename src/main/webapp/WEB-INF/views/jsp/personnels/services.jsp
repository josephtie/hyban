						...
						<div class="bars">
	    					...
	    					<table id="table" class="table table-info table-striped"
			       			...
			       			data-search="true">
			        			...
			        			<th data-field="libelle" data-formatter="departementFormatter" data-align="left" data-sortable="true">Sous-Direction</th>
...
<!--                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
                ...
                <div class="modal-body">
                	<div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select id="typeService" name="idTypeService" class="form-control select2"  required="required" style="width: 400px">
                	...
                	<div class="form-group direction">
                        ...
                        <div class="col-md-10">
                            <select id="direction" name="idDirection" class="form-control select2"  style="width: 400px">
                	...
                	<div class="form-group departement">
                        ...
                        <div class="col-md-10">
                            <select id="departement" name="idDepartement" class="form-control select2" style="width: 400px">
                	...
                	<div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="libelle" name="libelle" ng-model="service.libelle" class="form-control" placeholder="Libelle" />
                        </div>
                    </div>
                </div>
		...
		jQuery.ajax({
            ...
            success: function (response) {
        		...
        		for (i = 0; i < response.length; i++) {
					...
					jQuery('#departement').html(tabledata);
					jQuery('#departement').select2('val', 0);
            ...
            beforeSend: function () {
            	jQuery("#departement").html('<option value="0">Aucun resultat</option>');
            	jQuery("#departement").select2().trigger('change');
                /*$("#formAjout").attr("disabled", true);
                $("#rhpModal .modal-footer span").addClass('loader');*/
            },
