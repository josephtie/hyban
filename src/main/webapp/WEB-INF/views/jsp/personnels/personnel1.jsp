                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control input-small" id="statut" name="statut" ng-change="statutAbsence(absencePersonnel)" ng-model="absencePersonnel.statut" ng-init="absencePersonnel.statut='false'">
