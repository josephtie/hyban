        ...
        <div class="panel panel-warning">
            <div class="panel-heading">
                <div class="panel-title-box">
                    <h3>Liste des Types de Sanction</h3>
                    <span></span>
                </div>
            ...
            <table id="table" class="table table-info table-striped"
                   ...
                   data-url="${pageContext.request.contextPath}/carriere/paginertypesanctions"
        ...
        <div class="modal-content">
            <form id="formAjout" class="form-horizontal" role="form" novalidate="novalidate" ng-controller="formAjoutCtrl">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Type de sanction</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="libelle" class="col-md-2 control-label">Libell&eacute;</label>
                        <div class="col-md-10">
                            <input type="text" id="libelle" name="libelle" ng-model="typeSanction.libelle" class="form-control" placeholder="Libell�" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-md-2 control-label">Description</label>
                        <div class="col-md-10">
                            <textarea class="form-control" id="description" name="description" ng-model="typeSanction.description" placeholder="Description">
                ...
                <div class="modal-footer">
                    <input type="text" class="hidden" ng-hide="true" value="" id="id" name="id" ng-model="typeSanction.id">
                    <span></span>&nbsp;
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <form id="formDelete" ng-controller="formDeleteCtrl" action="#" method="post">
                ...
                <div class="modal-body">
                    <h4 ng-bind="typeSanction.info"></h4>
                </div>
                <div class="modal-footer">
                    <input type="text" class="hidden" ng-hide="true" value="" name="id" ng-model="typeSanction.id">
                    <span></span>&nbsp;
                    <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button>
                    <button type="submit" class="btn btn-success">Valider</button>
                </div>
...
<script type="text/javascript">
    ...
    app.controller('formAjoutCtrl', function ($scope) {
        $scope.pupulateForm = function (typeSanction) {
            $scope.typeSanction = typeSanction;
        };
    ...
    var actionUrl = "/carriere/enregistrertypesanction";
    var actionDeleteUrl = "/carriere/supprimertypesanction";
    var action = "ajout";
    var $table;
    ...
    function optionFormatter(id, row, index) {
        var option = '<a onclick="edit(' + row.id + ')" data-toggle="modal" data-target="#rhpModal" href="#" title="Modifier typeSanction [LIBELLE : ' + row.libelle + ' ]">  <span class="glyphicon glyphicon-file"></span></a>&nbsp;';
        option += '&nbsp;<a onclick="del(' + row.id + ')" data-toggle="modal" data-target=".deleteModal" href="#" title="Suprimer typeSanction [LIBELLE : ' + row.libelle + ' ]"> <span class="glyphicon glyphicon-trash"></span></a>';
    ...
    function edit(idTypeSaction) {
        ...
        var typeSanction = _.findWhere(rows, {id: idTypeSaction});

        $scope.$apply(function () {
            $scope.pupulateForm(typeSanction);
        });
    }
    ...
    function del(idTypeSaction) {
        ...
        var rows = $table.bootstrapTable('getData');
        var typeSanction = _.findWhere(rows, {id: idTypeSaction});
        typeSanction.info = typeSanction.libelle;
        $scope.$apply(function () {
            $scope.pupulateForm(typeSanction);
        });
    }
