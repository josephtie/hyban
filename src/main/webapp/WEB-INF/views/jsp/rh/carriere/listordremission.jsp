...
<script type="text/javascript">
    ...
    function optionFormatter(id, row, index) {
        var option = '<a onclick="edit(' + row.id + ')" data-toggle="modal" data-target="#rhpModal" href="#" title="Modifier mission [LIBELLE : ' + row.personnel.nomComplet + ' ]">  <span class="glyphicon glyphicon-file"></span></a>&nbsp;';
        option +=  '&nbsp; <a   target="_blank" href="${pageContext.request.contextPath}/absence/printOrdrmission?id='+row.id+'" title="Imprimer Ordre de mission [NOM : '+row.personnel.nomComplet+' ]"><span class="glyphicon glyphicon-print"></span> </a>&nbsp;';
