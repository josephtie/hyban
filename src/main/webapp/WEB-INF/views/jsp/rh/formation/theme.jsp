...
<div class="widget">
    <div class="widgetbox">                        
        <div class="headtitle">
            ...
            <h4 id="widgetTitle" class="widgettitle">Liste des th&egrave;mes</h4>
        </div>
        <div id="tableWidget" class="widgetcontent">
            <table id="table" class="table table-info table-striped"
                   ...
                   data-url="${pageContext.request.contextPath}/formation/paginerthemes"
                ...
                <thead>
                    <tr>
                        <th data-field="intitule">Intitul&eacute;</th>
            ...
            <form id="formAjout" class="form-horizontal" role="form" novalidate="novalidate" ng-controller="formAjoutCtrl">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="intitule" name="intitule" ng-model="theme.intitule" class="form-control" placeholder="Intitulé" />
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function optionFormatter(id, row, index) {
        var option = '<a onclick="edit(' + row.id + ')" data-toggle="modal" data-target="#rhpModal" href="#" title="Modifier theme [LIBELLE : ' + row.intitule + ' ]">  <span class="glyphicon glyphicon-file"></span></a>&nbsp;';
        option += '&nbsp;<a onclick="del(' + row.id + ')" data-toggle="modal" data-target=".deleteModal" href="#" title="Suprimer theme [LIBELLE : ' + row.intitule + ' ]"> <span class="glyphicon glyphicon-trash"></span></a>';
    ...
    function edit(idTypeSaction) {
        ...
        var theme = _.findWhere(rows, {id: idTypeSaction});
